...
import AcidenteImage from "./../../../../img/descarrilamentoT.png"
...
class Descarrilamento extends Component {
    constructor(props) {
        super(props);
        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.buttonPrincipal}>
                        ...
                        <Text style={styles.txtAlerta}>Descarrilamento</Text>
                </View>
...
export default Descarrilamento
